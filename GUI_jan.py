...
def main():
    ...
    button = ttk.Button(frame_2,text="実行",command=lambda:[create_facility_dict(var_umeda.get(),var_takatsuki.get()),mult_get_table([arrange_date(calender_date),hour.get()+":"+minute.get(),use_number.get(),use_minute.get(),course.get()],tree)])
